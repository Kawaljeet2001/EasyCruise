	...
	>
		<div class="flex items-center">
			<img
				...
				class="h-6"
			/>
			<li class="font-light mx-4 list-none">Air India AI839</li>
			<li class="font-light mx-4">A321</li>
			<li class="font-light mx-4">Economy</li>
		</div>
		...
		<div class="col-span-8 gap-x-4 grid grid-cols-12 border-r-2 border-gray-300 border-dashed">
			<div class="py-6 px-4 col-span-4 flex flex-col items-start">
				<p class="text-3xl font-light">
					DEL <span class="font-medium">{details.departureTime}</span>
				</p>
				<p class="text-gray-400 text-sm mt-1">Mon, 24 Oct</p>
				<p class="text-gray-400 text-sm">Indira Gandhi Intl Airport</p>
				<p class="text-gray-400 text-sm">New Delhi</p>
			</div>
			...
			<div class="py-6 px-4 col-span-5 flex flex-col items-end">
				<p class="text-3xl font-light">
					HYD <span class="font-medium">{details.arrivalTime}</span>
				</p>
				<p class="text-gray-400 text-sm mt-1">Mon, 24 Oct</p>
				<p class="text-gray-400 text-sm">Indira Gandhi Intl Airport</p>
				<p class="text-gray-400 text-sm">New Delhi</p>
